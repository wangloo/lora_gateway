...
#define RF_OPMODE_SLEEP                             0x00  /* 睡眠         */
#define RF_OPMODE_STANDBY                           0x01  /* Default 待机 */
#define RF_OPMODE_SYNTHESIZER_TX                    0x02  /* 频率合成发送 */
#define RF_OPMODE_TRANSMITTER                       0x03  /* 发送         */
#define RF_OPMODE_SYNTHESIZER_RX                    0x04  /* 频率合成接收 */
#define RF_OPMODE_RECEIVER                          0x05  /* 持续接收     */
