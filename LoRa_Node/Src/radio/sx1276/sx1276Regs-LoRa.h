...
// LoRa registers
#define REG_LR_FIFOADDRPTR                          0x0D    /* FIFO 数据缓冲区中 SPI 接口地址指针 */
...
#define RFLR_OPMODE_SLEEP                           0x00  /* 睡眠         */
#define RFLR_OPMODE_STANDBY                         0x01  /* Default 待机 */
#define RFLR_OPMODE_SYNTHESIZER_TX                  0x02  /* 频率合成发送 */
#define RFLR_OPMODE_TRANSMITTER                     0x03  /* 发送         */
#define RFLR_OPMODE_SYNTHESIZER_RX                  0x04  /* 频率合成接收 */
#define RFLR_OPMODE_RECEIVER                        0x05  /* 持续接收     */
// LoRa specific modes
#define RFLR_OPMODE_RECEIVER_SINGLE                 0x06  /* 单次接收     */
#define RFLR_OPMODE_CAD                             0x07  /* 信道活动检测 */
 ...
 * RegIrqFlags
 */
#define RFLR_IRQFLAGS_RXTIMEOUT                     0x80    /* 超时中断屏蔽                  */
#define RFLR_IRQFLAGS_RXDONE                        0x40    /* 数据包接收完成中断屏蔽        */
#define RFLR_IRQFLAGS_PAYLOADCRCERROR               0x20    /* 负载 CRC 错误中断屏蔽         */
#define RFLR_IRQFLAGS_VALIDHEADER                   0x10    /* Rx 模式下接收到的有效报头屏蔽 */
#define RFLR_IRQFLAGS_TXDONE                        0x08    /* FIFO 负载发送完成中断屏蔽     */
#define RFLR_IRQFLAGS_CADDONE                       0x04    /* CAD 完成中断屏蔽              */
#define RFLR_IRQFLAGS_FHSSCHANGEDCHANNEL            0x02    /* FHSS 改变信道中断屏蔽         */
#define RFLR_IRQFLAGS_CADDETECTED                   0x01    /* 检测到 CAD 中断屏蔽           */
